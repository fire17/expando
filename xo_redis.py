...
class Redis(Expando):
	...
	def _read_(self, *args,**kwargs):
		print(" WILL READ ",  type(self), self._id, args, kwargs, " ON REDIS")
	...
	def _create_(self, value, *args,**kwargs):
		print(" WILL CREATE ", type(self), self._id, value, args, kwargs, " ON REDIS")
		# Create key on redis
	
	def _update_(self, value, *args,**kwargs):
		print(" WILL UPDATE ",  type(self), self._id, value, args, kwargs, " ON REDIS")
		# Update key on redis

	def _subscribe_to_changes_(self, *args,**kwargs):
		print(" WILL SUBSCRIBE HERE TO ",  type(self), self._id, args, kwargs, " ON REDIS")
...
class xoRedis(Expando):
	...
	def _create_(self, id, *args,**kwargs):
		print(" WILL CREATE ", id, args, kwargs, " ON REDIS")
		print(" WILL SUBSCRIBE HERE TO ", id, args, kwargs, " ON REDIS")

	def update(self, id, *args,**kwargs):
		print(" WILL UPDATE ", id, args, kwargs, " ON REDIS")

	def _read_(self, id, *args,**kwargs):
